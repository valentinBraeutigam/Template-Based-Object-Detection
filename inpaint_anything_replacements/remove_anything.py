...
def setup_args(parser):
    ...
    parser.add_argument(
        ...
        help="Path to corresponding mask",
    )
    parser.add_argument(
        "--coords_type", type=str, required=True,
        default="key_in", choices=["click", "key_in","ignore"], 
...
if __name__ == "__main__":
    ...
    if args.mask is None:
        ...
        masks = load_img_to_array(args.mask)
        masks = masks[:,:,0]
